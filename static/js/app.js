...
function getRandomSafeSpot() {
    // We don't look things up by key here, so just return a x/y
...
const collectCoin = new Audio("/static/audio/collect-coin.mp3");
...
(function () {
    ...
    function initGame() {
        ...
        // Touch
        new TouchListener("Up", () => handleArrowPress(0, -1));
        new TouchListener("Down", () => handleArrowPress(0, 1));
        new TouchListener("Left", () => handleArrowPress(-1, 0));
        new TouchListener("Right", () => handleArrowPress(1, 0));
